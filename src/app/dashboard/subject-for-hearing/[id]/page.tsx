...
import CaseTrackingSubjectForHearing from "@/components/CaseTrackingSubjectForHearing";
...
export default function CaseRecordPageClient({
  params,
  AcademicdHead,
}: {
  AcademicdHead: any;
      ...
      <div className="flex gap-4 h-full">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              {AcademicdHead ? (
                ...
                <>
                  <ForHearingDialog
                    caseId={id}
                    caseNumber={studentData.caseNumber}
                    sentBy={studentData.sentBy}
                    subjectForHearing={studentData.subjectForHearing}
                    ...
                    setForHearing={studentData.setForHearing}
                  />
                </>
              )}
            </div>
            <div className="space-y-2 max-w-[70em]">
              <p className="text-sm">Name: {studentData.sentBy}</p>
              <p className="text-sm">
              ...
              <div className="space-y-2">
                <p className="text-sm break-words overflow-wrap break-word mt-10">
        ...
        <div className="w-80 shrink-0">
          <div className="bg-white rounded-md shadow-sm p-4 sticky top-4">
            ...
            <CaseTrackingSubjectForHearing caseId={id} />
          </div>
        </div>
      </div>
    </div>
