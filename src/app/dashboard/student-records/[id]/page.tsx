...
import CaseTrackingSolved from "@/components/CaseTrackingSolved";
import CaseResolutionDialog from "@/dialog/CaseResolutionDialog";
import { Button } from "@/components/ui/button";
import CaseTrackingStudent from "@/components/CaseTrackingStudent";
import CompleteResolutionDialog from "@/dialog/CompleteResolutionDialog";
        ...
        <div className="flex-1 flex flex-col gap-4 shadow-sm">
          ...
          <div className="bg-white rounded-md p-6 flex-1">
            <div className="flex justify-between items-center mb-6">
              ...
              {!resolutionStatus || resolutionStatus !== "Complete" ? (
                <CompleteResolutionDialog caseId={id} />
              ) : null}
            </div>
