...
import SetResolution from "@/dialog/SetResolution";
          ...
          <div className="flex justify-between border-b-2" key={cases.id}>
            ...
            <div className="my-auto">
              <SetResolution
                ...
                case_resolution={cases.sent_by}
                case_resolution_start_date={cases.sent_by}
                case_resolution_end_date={cases.sent_by}
              ></SetResolution>
            </div>
          </div>
        ))}
